...
public class CharactersProvider {
    ...
    public Character getCharacterByEnumAndCharacterName(Context context, EnumGames enumGames, String characterName) {
    ...
    private DBFZCharacter getDBFZCharacter(Context context, String characterName) {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                //ANTES DE ASIGNAR NADA DEL JSON, COMPROBAMOS SI ESE PERSONAJE TIENE ESA INFO
